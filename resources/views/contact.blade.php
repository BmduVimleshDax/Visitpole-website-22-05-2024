...
<div class="container-fluid">
    <!-- <div class="col-md-1 m-auto mb-2 ">
        ...
        <div class="col-md-6 mt-5 pe-3 ">
                <img src="{{ asset('assets/images/contact-image.webp') }}" alt="" class="photomain" style="width: 100%; height:100%;">
            </div>
 
        <div class="col-md-6 mt-5 pl-5 pe-5 " style="box-shadow: 0 1rem 3rem rgba(0,0,0,.175)!important;">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fas fa-envelope-open-text mx-2" style="color:#003366;"></i><small
    ...
    <div class="col-lg-12 col-md-6 mt-5 mb-4" style="padding-right: 0px !important;">
        <iframe
