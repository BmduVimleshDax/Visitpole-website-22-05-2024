...
function initializeClock(id) {
  ...
  var suffixSpan = clock.querySelector('.suffix');
...
initializeClock('clockdiv');
                    ...
                    <div class="col-lg-6 ">
                        <a href={{ url('/') }} class="text-decoration-none">
                            ...
                            <div style="background-color:#c20017; font-size:16px; padding:7px 7px;" class="text-white text-center">
                                TOP POSTS
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 ">
                        <ul class="list-inline ">
                            <a href="https://www.facebook.com/visitpole/">
                                <li class="list-inline-item facebook"><i class="fa-brands fa-facebook-f fas1" style="padding:10px 12px 10px 12px;"></i></li>
                            </a>
                            <a href="https://twitter.com/visitpole">
                                <li class="list-inline-item"><i class="fab fa-twitter fas1 "></i></li>
                            </a>
                            <a href="https://www.youtube.com/@visitpole">
                                <li class="list-inline-item"><i class="fab fa-youtube fas1 "></i></li>
                            </a>
                        </ul>
                    </div>
                    <div class="col-lg-8">
                        <a href="#subscribe" class="text-decoration-none">
                            <div class=" text-white text-center fas1" style="background-color:#c20017; font-size:16px; padding:7px 7px;" class="text-white">
                                <i class="fas fa-envelope ml-1 mx-1"></i> Subscribe NewsLatters
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <footer class="mobilefooter">
        <div class="footermobile">
            <div class="dropdown">
                <a href={{ url('/') }}><img class="footerlogo" src="{{ asset('assets/images/Logoblack.png') }}" alt="visitpole"></a>
                <a class="nav-link dropdown-toggle" href="#" id="dropdownButton" role="button" data-toggle="dropdown" aria-haspopup="true" 
                aria-expanded="false" style="font-size:15px; color:white;">
              Important Links
                </a>
            ...
            <div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownButtonServices" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:15px; color:white;">
                    About Links
                </a>
                ...
                <ul id="dropdownListServices">
                    ...
                    <li class="p-2"><a href="{{ url('contact') }}" class="text-decoration-none text-white">Contact Us</a>
                    </li>
                    <li class="p-2"><a href="{{ url('advertise') }}" class="text-decoration-none text-white">Advertise With
                            Us</a></li>
                    <li class="p-2"><a href="{{ url('media') }}" class="text-decoration-none text-white">Media
                            Relations</a></li>
                    <li class="p-2"><a href="{{ url('corporate-infomation') }}" class="text-decoration-none text-white">Corporate
                            Information</a></li>
                    <li class="p-2"><a href="{{ url('compliance') }}" class="text-decoration-none text-white">Compliance</a>
                    </li>
                    <li class="p-2"><a href="{{ url('apps-products') }}" class="text-decoration-none text-white">Apps &
                            Products</a></li>
                </ul>
            </div>
            <div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownButtonusefull" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:15px; color:white;">
                    Usefull Links
                </a>
            ...
            <div class="dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdownButtonnews" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:15px; color:white;">
                    Newsletter
                </a>
                ...
                <small class="text-secondary bm mx-4">&copy; 2024 – All Right Reserved. Designed and Developed by
                    <b class="text-white"><a href="https://digitalutilization.com/" class="text-decoration-none text-white">BM Digital Utilization LLP</a></b></small>
                <ul class="list-inline  text-white ml-5" style="text-align: center;">
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-facebook-f"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-instagram"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-linkedin-in"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-youtube"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fas fa-chevron-up"></i></a></li>
                </ul>
            </div>
    </footer>
    <div style="background-color:#212529;" class="container-fluid mt-5 text-center laptopfooter">
        ...
        <div class="row justify-content-around footer">
            <div class="col-8  col-md-4 pt-1">
                ...
                <div class="logo-f"><a href={{ url('/') }}><img src="{{ asset('assets/images/visitpolelogofront.png') }}" alt="visitpole"></a></div>
                <div class="ps-4 mt-3">
                ...
                <div>
                    ...
                    <form action="" method="Post" id="footer_subn_form">
                        ...
                        <div class="form-group mt-3 mb-4">
                            <input type="submit" name="fsubmit" class="form-control" value="SUBSCRIBE" style=" font-weight:bold; font-family:'poppins',sans-serif !important;">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="row p-3 justify-content-between">
                    <div class="col-12 col-md-6  footerl ps-5">
                        <small class="text-secondary bm">&copy; 2024 – All Right Reserved. Designed and Developed
                            by <b class="text-white"><a href="https://digitalutilization.com/" class="text-decoration-none text-white">BM Digital Utilization
                                    LLP</a></b></small>
                    </div>
                    <div class="col-md-3"></div>
                    <div class="col-12 col-md-3 ps-5">
                        <ul class="list-inline  text-white ml-5 ">
                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-facebook-f"></i></a>
                            </li>
                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-twitter"></i></a>
                            </li>
                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-linkedin-in"></i></a>
                            </li>
                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fab fa-youtube"></i></a>
                            </li>

                            <li class="list-inline-item"><a href="#" class="text-decoration-none text-white"><i class="fas fa-chevron-up"></i></a>
                            </li>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5232685410418742" crossorigin="anonymous"></script>
    <script>
        function myFunction() {
